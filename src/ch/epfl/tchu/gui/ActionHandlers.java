...
/**
 * Contient cinq interfaces fonctionnelles imbriquées représentant les différents gestionnaires d'actions.
 *
...
public interface ActionHandlers {
    ...
    interface DrawCardHandler {
        /**
         * Est appelée lorsque le joueur désire tirer la carte à l'emplacement donné.
         *
    ...
    interface ChooseCardsHandler {
         ...
         * lors de la prise de possession d'une route; s'il s'agit de cartes additionnelles, alors le multi-ensemble
